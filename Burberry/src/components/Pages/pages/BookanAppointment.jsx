    ...
    <>
      ...
      <div style={{"display":"grid","justify-content":'center',"marginTop":"35px"}}>
        <h1 style={{"fontWeight":"500","fontFamily":"arial","textAlign":'center',"fontSize":"50px"}}>Personalised Services</h1>
         <div style={{"display":"flex","flexDirection":"row", "fontSize":"0.95em","gap":"20px","justifyContent":"center","position":"relative","bottom":"20px"}}>
         ...
         <div><br></br><br></br>
          <img src='https://img.freepik.com/free-vector/flat-christmas-plaid-pattern-design_23-2149209404.jpg?size=626&ext=jpg' alt='bbackgroundimage' style={{"height":"500px","width":"1400px","marginTop":"30px","marginBottom":"-200px"}}></img>
         </div>
      </div>
    </>
